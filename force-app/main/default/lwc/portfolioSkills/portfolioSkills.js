...
import SOFTWARE_TOOL_FIELD from '@salesforce/schema/Portfolio__c.SoftwareTools__c'
...
export default class PortfolioSkills extends LightningElement {
    ...
    @wire(getRecord, {
        recordId:'$recordId',
        fields:[TECH_SKILLS_FIELD, SOFT_SKILLS_FIELD, SOFTWARE_TOOL_FIELD, METHODOLOGIES_FIELD]
